...
public class PlateDocumentViewer extends DocumentViewer{
    ...
    private void updateThermocycleAction(boolean showDialogs){
        ...
        thermocycleAction = new GeneiousAction.SubMenu(new GeneiousActionOptions("Thermocycle: "+name.get(), null, MooreaPlugin.getIcons("thermocycle_16.png")), actions);
    ...
    GeneiousAction gelAction = new GeneiousAction("Attach GEL image", null, MooreaPlugin.getIcons("addImage_16.png")) {
        public void actionPerformed(ActionEvent e) {
            if(!MooreaLabBenchService.getInstance().isLoggedIn()) {
                Dialogs.showMessageDialog("Please log in");
                return;
