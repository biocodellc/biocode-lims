    ...
    private List<DisplayFieldsTemplate> getDisplayFieldsTemplatesFromDisk(Reaction.Type type) throws JDOMException, IOException, XMLSerializationException{
        ...
        if(!file.exists()) {
            ...
            switch(type) {
                ...
                case GelQuantification: return Arrays.asList(new DisplayFieldsTemplate("Default", Reaction.Type.GelQuantification, GelQualificationReaction.getDefaultDisplayedFields(), new Reaction.BackgroundColorer(null, Collections.<String, Color>emptyMap())));
...
//        cycles.add(tc);
    ...
    public Map<String, Workflow> getWorkflows(Collection<String> workflowIds) throws DatabaseServiceException {
        List<Workflow> list = getActiveLIMSConnection().getWorkflowsByName(workflowIds);
