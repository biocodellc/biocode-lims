...
CREATE TABLE `assembly` (
  ...
  `disagreements` int(10) unsigned NOT NULL,
  `edits` longtext NOT NULL,
  `reference_seq_id` int(10) unsigned NOT NULL,
  `confidence_scores` longtext NOT NULL,
  `trim_params_fwd` longtext NOT NULL,
  `trim_params_rev` longtext NOT NULL,
  `other_processing_fwd` longtext NOT NULL,
  `other_processing_rev` longtext NOT NULL,
