...
CREATE TABLE  thermocycle  (
   id  INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 16) PRIMARY KEY,
   name  varchar(64),
   notes  LONGVARCHAR NOT NULL
);
...
CREATE TABLE cycle (
  id INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 29) PRIMARY KEY,
...
CREATE TABLE  pcr_cocktail  (
   id  INTEGER  GENERATED BY DEFAULT AS IDENTITY(START WITH 17) PRIMARY KEY,
   name  varchar(99) NOT NULL,
...
CREATE TABLE  pcr_thermocycle  (
   id  INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 3) PRIMARY KEY,
   cycle INTEGER
);
